    ...
    <div class="discover_spaces" style="padding:12px">
        ...
        <div class="discover_spaces_div_container">
            <div class="discover_spaces_div" style="position:relative;border-radius:9px;border:1px solid #888;width:41%;height:fit-content">
                <div style="height:15%;width:100%;overflow:hidden"><img src="/static/images/spaces_cover_photo1.png" style="width:100%;height:auto;border-radius:9px 9px 0 0"/></div>
                ...
                <div style="height:85%;width:100%;background-color:#fff">
                    ...
                    <div style="text-align:center;padding:0 12px">The Eyes of Medicine. Can yoy make a diagnosis from these x-ray images?</div>
                </div>
            </div>
        </div>
