...
class Index_Segments{
    ...
    public static function main_header($site_name = SITE_NAME_SHORT) {
        echo <<<HTML
            ...
            <!-- .join_us starts -->
            <div class="join_us" style="position:fixed;top:60px;right:15px;z-index:10;line-height:18px;background-color:#fff;border-radius:6px;box-shadow:0 0 3px 0 #d6e2fb">
