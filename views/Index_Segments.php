                ...
                <div class="main_body">
                    ...
                    <div style="display:flex;margin:12px 6px;padding-bottom:12px">
                        ...
                        <div style="margin-left:6px">
                            <div style="font-size:15px"><b>Francis Arinze</b> <i class="fa fa-circle" style="font-size:12px"></i> <b style="color:#2b8eeb">Follow</b></div>
                            <div style="color:#888;font-size:12px">Orthopaedic Doctor (2007 - present) <i class="fa fa-circle" style="font-size:6px"></i> 21h</div>
                        </div>
                    </div>
                </div>
                <!-- .main_body ends -->
