    ...
    public static function main_header($site_name = SITE_NAME_SHORT) {
        echo <<<HTML
            ...
            <div class="join_us" style="position:fixed;top:60px;right:15px;z-index:10;line-height:60px;background-color:#fff;border-radius:6px;box-shadow:0 0 3px 0 #d6e2fb;text-align:center;">
                ...
                <div>
                    <a href="/create-or-login"><span class="button" style="padding:18px 12px">Sign up</span></a>
                </div>
                <div>
                    <a href="/create-or-login"><span class="button" style="padding:18px 12px;border:1px solid #888;background-color:#fff;color:#888">Sign in</span></a>
                </div>
