...
if($data){//if user is logged in:
    ...
    if(isset($_POST["write_up"])) {
        ...
        if ($_FILES['add_image1']['error'] !== UPLOAD_ERR_OK) {
            echo "<div class='invalid'>No image uploaded. Error code " . $_FILES['add_image1']['error']."</div>";
        }
    }
} else {
            ...
            foreach($posts_data as $post_d) {
                if ($data){
                    if (isset($_POST["comment_on_post_$post_d->post_id"])) {
                        $comment_check_stmt = self::$pdo->prepare("SELECT * FROM comments WHERE (comment = ? AND post_id = ? AND user_id = ?)");
                ...
                $post_nl2br = nl2br(substr($post_d->body, 0, 150))."<b onclick="."post_nl2br_view_more('$post_d->post_id')".">...view more</b>";
                ...
                echo <<<HTML
                    ...
                    <div class="posts_and_questions" style="margin:12px 6px">
                        ...
                        <div class="answers" style="padding:6px">
                            ...
                            <div id="post_nl2br_$post_d->post_id" style="margin-top:0;margin-bottom:15px">$post_nl2br</div>
HTML;
...
HTML;
                        ...
                        foreach($comment_data as $comm_d){
                            ...
                            echo <<<HTML
                                <div style="display:flex;padding:18px;border-top:1px solid #888;margin:3px 9px">
                                    <div class="profile_image_div">
        ...
        <br/><br/><br/><br/>
            <div class="footer"><!-- .footer starts --> 
                ...
                <div>
                    ...
                    <p>We encourage different story-telling formats: write-ups/videos, so you can utilize our <a href="/">feed</a> or <a href="/reels">reels</a> section - depending on your preferred method of learning.</p>
